...
class ConfigSemantic3D:
    ...
    batch_size = 4  # batch_size during training 4
    val_batch_size = 16  # batch_size during validation and test
...
class ConfigScanNet:
    ...
    val_batch_size = 16  # batch_size during validation and test
    train_steps = 800  # Number of steps per epochs
    val_steps = 300  # Number of validation steps per epoch

    sub_sampling_ratio = [4, 4, 4, 4, 2]  # sampling ratio of random sampling at each layer
    # sub_sampling_ratio = [2, 2, 2, 2, 2, 2, 2, 2, 2]
    d_out = [16, 64, 128, 256, 512]  # feature dimension
    # d_out = [16, 64, 64, 64, 128, 128, 256, 256, 512, ]
