...
from tester_S3DIS_weak import ModelTester
...
if __name__ == '__main__':
    ...
    parser.add_argument('--labeled_point', type=str, default='1%' )
    ...
    parser.add_argument('--topk', type=int, default=500, help='topk')
