...
def convert_pc2ply(anno_path, save_path):
    ...
    for f in glob.glob(join(anno_path, '*.txt')):# for every instance
    ...
    xyz_min = np.amin(pc_label, axis=0)[0:3]#[1136617,7]
...
if __name__ == '__main__':
    ...
    for annotation_path in anno_paths:
        #annotation_path = annotation_path.replace("Annotations", "Annotations_weakly")
