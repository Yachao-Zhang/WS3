...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        if dataset_name is 'S3DIS':
            ...
            #     [17314545, 13327131, 11989728, 1909991, 1291399, 3122500, 1197818, 1818311, 1942293, 1332850, 1000934,
            ...
            num_per_class = np.array(
                [13327131, 11989728, 1909991, 1291399, 3122500, 1197818, 1818311, 1942293, 1332850, 1000934,
                 227936, 244557,892883, 800339, 246651, 125533, 134002, 110112, 162706, 1575880], dtype=np.int32) #去掉第0个索引
